...
export default function Signup() {
  ...
  useEffect(() => {
    setNotificationswitch(document.getElementById("notificationswitch") as HTMLInputElement);
  ...
  return (
    <main>
      ...
      <div id='accountpanel' hidden style={{position: "absolute", top: "36%", left: "54.5%", transform: "translate(-50%, -50%)"}} className='bg-[rgb(18,18,18)] z-10 shadow-slate-600 shadow-[0px_0px_20px_3px] p-4 m-4 rounded-xl w-[80vw] h-56'>
        ...
        }} style={{width: "22%", borderRadius: "10px", marginLeft: "1%"}} color='blue'>Update</Button>
        <br />
      </div>
      ...
      <div id='appearancepanel' hidden style={{position: "absolute", top: "36%", left: "54.5%", transform: "translate(-50%, -50%)"}} className='bg-[rgb(18,18,18)] z-10 shadow-slate-600 shadow-[0px_0px_20px_3px] p-4 m-4 rounded-xl w-[80vw] h-56'>
        
      </div>

      <div id='dangerpanel' hidden style={{position: "absolute", top: "36%", left: "54.5%", transform: "translate(-50%, -50%)"}} className='bg-[rgb(18,18,18)] z-10 shadow-slate-600 shadow-[0px_0px_20px_3px] p-4 m-4 rounded-xl w-[80vw] h-56'>
        <Text className='text-2xl font-medium'>Click On the Panels on the left side to change settings</Text>
      </div>
    </main>
  )
