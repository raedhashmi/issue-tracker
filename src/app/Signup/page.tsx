  ...
  return (
    <main>
      <form style={{position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)"}} className='bg-[rgb(18,18,18)] shadow-slate-600 text-center items-center shadow-[0px_0px_20px_3px] rounded-xl mb-2 mt-2 p-4'>
        ...
        <br />
        <input type="text" onChange={(e) => setUsername(e.target.value)} className='border-2 rounded-xl p-2 m-2' placeholder="Username" />
        <br />
        <div className='relative'>
          <input type={showPassword ? "text" : "password"} onChange={(e) => setPassword(e.target.value)} className='border-2 rounded-xl p-2 m-2' placeholder="Password" />
